using Dungeons_Diners_Drive_Ins_Dragons_Dives.Source.Dialogue_Trees.Guard;
using Dungeons_Diners_Drive_Ins_Dragons_Dives.Source.GameLogic.Dialogue;
using System;
...
namespace Dungeons_Diners_Drive_Ins_Dragons_Dives {
    ...
    public partial class DialogueForm : Form {
        ...
        private void button3_attack_Click(object sender, EventArgs e) {

        }

        private void button_rizz_Click(object sender, EventArgs e) {
